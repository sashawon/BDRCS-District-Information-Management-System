		...
		<section class="main-heading bg-light pb-3">
			...
			<div class="container">
				<div class="row py-3">
					...
					$sql="SELECT * FROM employee ORDER BY id ASC LIMIT ".$this_page_first_result . "," .  $results_per_page;
					$stmt=$con->prepare($sql);
					$stmt->execute();
					$result=$stmt->fetchAll(PDO::FETCH_ASSOC);
					$number_of_results=$stmt->rowCount();
					...
					<div class="col-md-4 mt-5 text-center">
						<img style="width: 100px; height:120px; border-radius: 20%;" class="img-fluid" src="<?php echo 'images/office_employee/'.$row["photo"]; ?>" alt="Photo">
