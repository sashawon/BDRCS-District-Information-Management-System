				...
				<div class="row py-5">
					<div class="col-lg-12 col-md-12 col-12 col-xxl-12 align-items-start flex-column">
						<div class="row">
							...
							$sql="SELECT * FROM report ORDER BY id DESC LIMIT ".$this_page_first_result . "," .  $results_per_page;
							$stmt=$con->prepare($sql);
							$stmt->execute();
							$result=$stmt->fetchAll(PDO::FETCH_ASSOC);
							$number_of_results=$stmt->rowCount();
				...
				<div class="container">
				  <div class="row">
				    <div class="col-md-12 d-flex flex-row-reverse">
				      ...
				      <li class="page-item">
				      <a class="page-link text-dark" href="report.php?id=<?= urlencode($row['id']) ?>&&page=<?= $page?>"><?php echo $page?></a>
				      </li>
