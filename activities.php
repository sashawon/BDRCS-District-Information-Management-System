		...
		<!-- End Header -->
		<!-- ======= activities Start ======= -->
		<section class="activities bg-light pb-3"  id="activities">
				...
				<div class="row py-5">
					<div class="col-lg-12 col-md-12 col-12 col-xxl-12 align-items-start flex-column">
						<div class="row">
							...
							$sql="SELECT * FROM activities ORDER BY id DESC LIMIT ".$this_page_first_result . "," .  $results_per_page;
							$stmt=$con->prepare($sql);
							$stmt->execute();
							$result=$stmt->fetchAll(PDO::FETCH_ASSOC);
							$total=$stmt->rowCount();
				...
				<div class="container">
				  <div class="row">
				    <div class="col-md-12 d-flex flex-row-reverse">
				      ...
				      <li class="page-item">
				      <a class="page-link text-dark" href="activities.php?id=<?= urlencode($row['id']) ?>&&page=<?= $page?>"><?php echo $page?></a>
				      </li>
			 ...
			 $(document).ready(function(){  
			      $('.view_data').click(function(){
			        //alert('hello');
			           ...
			           $.ajax({  
			                type:"POST",  
			                url:"view_activities_details.php",  
			                data:{
