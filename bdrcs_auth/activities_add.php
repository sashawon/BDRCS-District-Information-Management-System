<?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql= "INSERT INTO `activities`(`photo`, `title`, `des`, `type`, `date`, `category`, `file_type`) VALUES (:data,:title,:des,:type,:date,:category,:file_type)";

    $stmt = $con->prepare($sql);
    $query = $stmt->execute(['data'=>$data, 'title'=>$title, 'des'=>$des, 'type'=>$type, 'date'=>$date, 'category'=>$category, 'file_type'=>$file_type]);
            ...
            <div class="col-lg-12 main-chart">
              <form class="form-horizontal" action='' method="POST" enctype="multipart/form-data">
                <fieldset>
                  ...
                  <h3 class="text-center pb-4">Add Events</h3>                
                  <div class="row mb-3">
                    <!-- Activity Title -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select name="type" class="form-control" id="type">
                        ...
                        <option value="Emergency Event">Emergency Event</option>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="controls text-center">
                      <input type="submit" name="submit" value="Add Activity" class="btn btn-success">
                    </div>
                  </div>
                </fieldset>
              </form>
