            ...
            <!--<div class="col-lg-12 main-chart">
              <div class="row">
                ...
                <div class="col-7 d-flex flex-row-reverse">
                  <a class="btn btn-primary" href="print_volunteer.php?status=0&&query=<?php echo $query; ?>" target="_blank"><i class="fa fa-print"></i> Print</a>                  
                </div>             
              </div>
            </div>-->
            <div class="col-lg-12 main-chart">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="volunteer_approve.php?status=1&&id=<?php echo $row['id']; ?>" class="btn btn-warning m-1">Approve</a>
