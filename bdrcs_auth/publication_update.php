        ...
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12 main-chart">
              ...
              ?>
              <form class="form-horizontal" action='publication_update_final.php' method="POST" enctype="multipart/form-data">
                <fieldset> 
                  <h3 class="text-center pb-4">Update Publication</h3> 
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="controls text-center">
                      <input type="submit" value="Upadte Publication" name="submit" class="btn btn-success">
                    </div>
                  </div>
                </fieldset>
              </form>
