<?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($imageerror==0) {
      $destfile = '../images/ec_committee/'.$imagename;
      move_uploaded_file($imagepath, $destfile);
    }
      

    $sql= "INSERT INTO `ec_member`(`name`, `designation`, `email`, `mobile`, `duration`, `photo`) VALUES (:name,:designation,:email,:mobile,:duration,:imagename)";

    $stmt = $con->prepare($sql);
    $query = $stmt->execute(['name'=>$name, 'designation'=>$designation, 'email'=>$email, 'mobile'=>$mobile, 'duration'=>$duration, 'imagename'=>$imagename]);
            ...
            <div class="col-lg-12 main-chart">
              <form class="form-horizontal" action='' method="POST" enctype="multipart/form-data">
                <fieldset>
                  ...
                  <h3 class="text-center pb-4">Add Executive Committee</h3>                
                  <div class="row mb-3">
                    <!-- Full Name -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="email" name="email" placeholder="" value="<?= isset($email) ? $email:'' ?>" class="form-control">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="duration" name="duration" placeholder="" value="<?= isset($duration) ? $duration:'' ?>" class="form-control">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="controls text-center">
                      <input type="submit" value="Add Executive Committee" name="submit" class="btn btn-success">
                    </div>
                  </div>
                </fieldset>
              </form>
