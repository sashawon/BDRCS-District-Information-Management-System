<?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql= "INSERT INTO `report`(`photo`, `title`, `des`, `date`, `category`, `file_type`) VALUES (:data,:title,:des,:date,:category,:file_type)";
            ...
            <div class="col-lg-12 main-chart">
              <form class="form-horizontal" action='' method="POST" enctype="multipart/form-data">
                <fieldset>
                  ...
                  <h3 class="text-center pb-4">Add Report</h3>                
                  <div class="row mb-3">
                    <!-- report Title -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      ...
                      <p class="help-block">Please provide Image, required field</p>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="controls text-center">
                      <input type="submit" name="submit" value="Add Report" class="btn btn-success">
                    </div>
                  </div>
                </fieldset>
              </form>
